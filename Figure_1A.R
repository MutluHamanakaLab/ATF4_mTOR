...
read_abundance_atf4 <- read.csv("/PATH/TO/THE/FILE/TableOfCounts_atf4_filtered.csv")
read_abundance_mtor <- read.csv("/PATH/TO/THE/FILE/TableOfCounts_mTOR_filtered.csv")
